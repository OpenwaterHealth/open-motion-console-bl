...
/* Exported constants --------------------------------------------------------*/
#define SFU_UART                                UART4
#define SFU_UART_CLK_ENABLE()                   __HAL_RCC_UART4_CLK_ENABLE()
#define SFU_UART_CLK_DISABLE()                  __HAL_RCC_UART4_CLK_DISABLE()

#define SFU_UART_TX_AF                          GPIO_AF8_UART4
...
#define SFU_UART_RX_AF                          GPIO_AF8_UART4
